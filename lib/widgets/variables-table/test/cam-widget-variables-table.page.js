...
Variable.prototype.editBtn = function () {
  return this.actionsCell().element(by.css('.glyphicon-pencil'));
};
Variable.prototype.deleteBtn = function () {
  return this.actionsCell().element(by.css('.glyphicon-trash'));
};
Variable.prototype.saveBtn = function () {
  return this.actionsCell().element(by.css('.glyphicon-ok'));
};
Variable.prototype.revertBtn = function () {
  return this.actionsCell().element(by.css('.glyphicon-remove'));
};
